...
const ACTION_META = {
  ...
  CreateContainer: { icon: Container, color: '#14B8A6', desc: 'Create a new container', group: 'Device' },
  SwitchContainer: { icon: RefreshCw, color: '#F97316', desc: 'Switch to another container', group: 'Device' },
